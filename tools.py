...
def create_tools(**kwargs) -> AIMemorySystemTools:
    """创建记忆系统工具"""
    return AIMemorySystemTools(**kwargs)


if __name__ == "__main__":
    tools = create_tools()

    print("AI Memory System Tools")
    print()
